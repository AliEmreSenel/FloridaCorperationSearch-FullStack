                ...
                if title == "Filing Information":
                    ...
                    for i in range(len(labels)):
                        corp_details["filing_info"].append(
                            {
                                "internal_name": await labels[i].get_attribute("for"),
                    ...
                    if len(spans) > 2:
                        corp_details["registered_name"] = await spans[1].inner_text()
                        corp_details["registered_addr"] = await spans[2].inner_text()
                    if len(spans) > 3:
                        for span in spans[3:]:
                        ...
                        corp_details["documents"].append(
                            {
                                ...
                                "link": await report_link.get_attribute("href"),
                            }
                        )
        return corp_details
